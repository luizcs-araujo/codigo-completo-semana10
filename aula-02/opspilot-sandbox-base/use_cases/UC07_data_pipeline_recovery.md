# UC07 — Recuperação de pipeline de dados travado
...
O agente investiga pipeline de dados travado e pode reprocessar partição ou propor ajuste de watermark.

## Por que isso vale um agente?

Automatizar uma investigação que um analista faria ao perceber dashboard desatualizado e procurar partição/watermark.
