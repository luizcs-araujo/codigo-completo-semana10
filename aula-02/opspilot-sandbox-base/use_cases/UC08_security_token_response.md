...
`security.leaked_token`

## Cenário

O agente recebe alerta de segredo vazado e decide se revoga token, desabilita service account ou apenas escala.

## Por que isso vale um agente?

Reduzir janela de exposição de credenciais, sem permitir que o agente derrube sistemas sem aprovação.
