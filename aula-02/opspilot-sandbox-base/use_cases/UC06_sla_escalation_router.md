# UC06 — Roteamento e escalonamento automático por risco de SLA

## Evento de entrada

`support.sla_breach_risk`

## Cenário

O agente detecta risco de violação de SLA e decide se escala incidente para time correto com justificativa.

## Por que isso vale um agente?

Evitar que tickets críticos fiquem parados por falta de dono explícito.
