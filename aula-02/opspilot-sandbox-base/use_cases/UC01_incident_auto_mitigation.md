# UC01 — Auto-mitigação de erro 500 em serviço crítico

## Evento de entrada

`monitoring.error_spike`

## Cenário

O agente recebe um alerta de erro 500 em `checkout-api` e precisa decidir se apenas escala o incidente, reduz rollout de feature flag ou solicita restart/scale do serviço.

## Por que isso vale um agente?

Evitar que um humano precise notar o spike, correlacionar deploy/flag/incidente e iniciar a mitigação manualmente.
